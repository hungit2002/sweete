...
class Post extends Model
{
    ...
    {
        return $this->belongsToMany(User::class, Tag::TABLE, Tag::TABLE . '.' . Tag::_POST_ID, Tag::TABLE . '.' . Tag::_USER_ID)
            ->whereNull(Tag::TABLE . '.' . Tag::_DELETED_AT);
    }

    public function images()
    {
        return $this->hasMany(Image::class, Image::_POST_ID, self::_ID)->whereNull(Image::TABLE . '.' . Image::_DELETED_AT);
    }
